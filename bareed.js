...
credit = (money =>this.money = this.money + money)
debit = (money => this.money = this.money - money)
}


//console.log(new Wallet.credit(50))
/**********************************************************
...
//let person = new Person ("abb", 50 , 26 , 50)
//let point = new Point (5,9)
//person.moveTo(point)
/**********************************************************
